...
for i in range(0,size) :
    sns.violinplot(x = dataset[x], y = dataset[cols[i]])
...
sns.heatmap(data_corr, annot = True, fmt = '.2f', cmap = 'magma')  #cmap stands for color-map
...
#print(dataframe)
import numpy as np
top_k_predictors = dataframe[dataframe.scores > np.percentile(dataframe.scores, 80)]['Features'].tolist()
